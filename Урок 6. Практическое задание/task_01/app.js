...
let ticTakToe = {
    ...
    phase: 'X',     // фаза игры на текущий момент
    ...
    init() {
        // Выводим все ячейки.
        this.renderMap();
        // Инициализируем обработчики событий. (для кликов по ячейкам)
    ...
    fillCell(event) {
        ...
        this.mapValues[row][col] = this.phase;  // заполнение массива mapValues
        event.target.textContent = this.phase;  // отображение на странице заполненной ячейки
    },
